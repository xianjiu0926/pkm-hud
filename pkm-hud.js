(function(){
var css=':root{--frame:#7d95b5;--text:#c6d1e4;--dim:#8ba0b8;--hp:#32CD32;--male:#00BFFF;--female:#FF4500}'+
'*{box-sizing:border-box;margin:0;padding:0}'+
'html,body{font-family:"Segoe UI","Helvetica Neue","PingFang SC","Microsoft YaHei",monospace;color:var(--text);background:transparent;overflow-x:hidden}'+
...
fetchPokemon(name,function(d){
  ...
  if(f.formKey&&d.enname&&!f.artId){
    fetchFormId(d.enname,f.formKey,function(id){
      f.artId=id;
      renderPkmForm(curPkmForm);
    });
  }
});
  });
